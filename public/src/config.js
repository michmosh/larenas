const Config = {
    ...
    languages : [
        {name:'en' , flag:"https://restcountries.eu/data/usa.svg"},
        {name:'es' , flag:"https://restcountries.eu/data/mex.svg"}
    ] ,
    en:{
        "homeImageTitle":'Follow Your Dreams ...',
        "navLinks" : [
            {"name":"Home" , "path" : "/home"},
    ...
    es:{
        "homeImageTitle":'Persigue Tus Suenos ...',
        "navLinks" : [
            {"name":"Casa" , "path" : "/home"},
